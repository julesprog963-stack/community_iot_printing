{
    ...
    "images": [
        ...
        "static/description/images/iot_print_menu_odoo17.png",
        "static/description/images/iot_print_wizard_odoo17.png",
        "static/description/images/iot_print_queued_odoo17.png",
    ],
