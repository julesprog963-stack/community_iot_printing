{
    ...
    "images": [
        ...
        "static/description/images/iot_print_menu_odoo18.png",
        "static/description/images/iot_print_wizard_odoo18.png",
        "static/description/images/iot_print_queued_odoo18.png",
    ],
